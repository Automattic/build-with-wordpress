...
| [Antigravity connector research](antigravity-connector-research.md) | Official Antigravity integration surfaces, verified config paths, unknowns, and a safe generated-output plan. | Decide whether Antigravity is ready for generated package support. |
